...
//Name: timdissappear.ma
//Last modified: Wed, Jun 25, 2014 08:38:47 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.9412232450889402 0.0047471246243802057 -0.80208920504807746 ;
	setAttr ".r" -type "double3" 179.6616472703983 3.7999999999993892 180 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 0.80387052587433538;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.8879485388708237 0 0 ;
...
createNode transform -s -n "side";
	setAttr ".t" -type "double3" 100.1 -0.024300484589132254 -0.025390048709615781 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".ow" 30.000736011827751;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" -2.8421709430404007e-14 -1.9731024788211122 0.51239021674619933 ;
...
createNode imagePlane -n "imagePlaneShape1" -p "imagePlane1";
	setAttr -k off ".v";
	setAttr ".fc" 0;
	setAttr ".imn" -type "string" "/Users/KartikKini/Desktop/Screen Shot 2014-06-25 at 7.36.28 PM.png";
...
createNode transform -n "fluid1";
	setAttr ".t" -type "double3" 2.9265258931902585 -2.0204023394375099 0.5051005848593767 ;
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	setAttr ".bod" 2;
	setAttr ".lmth" 2;
	setAttr ".lmsf" 0.29015544056892395;
	setAttr ".dsc" 0.14814814925193787;
	setAttr ".dds" 0.24338624299203276;
	setAttr ".dsb" 0;
	setAttr ".sfat" 5;
	setAttr ".sfrp" 0;
	setAttr ".eqvl" 2;
	setAttr ".sfds" 14;
	setAttr ".grv" 4.7150259017944336;
	setAttr ".tfr" 0.17989417910575867;
	setAttr ".tbs" 0;
	setAttr ".cl[0].clp" 0;
...
createNode vortexField -n "vortexField1";
	setAttr ".t" -type "double3" 2.9254481685129088 -1.9502575841300462 0.54320035043172121 ;
	setAttr ".s" -type "double3" 3.6184219074603932 3.6184219074603932 3.6184219074603932 ;
	setAttr ".mag" -100;
	setAttr ".max" 2.4000000000000004;
	setAttr ".vol" 2;
	setAttr ".trra" 10;
	setAttr ".ten" no;
	setAttr ".tsr" 0.2;
...
createNode diskCache -n "initialState_fluidShape1";
	setAttr ".cn" -type "string" "timdissappear.ma_fluidShape1.mcfi";
...
connectAttr "vortexField1.of[3]" "fluidShape1.ifc[4]";
connectAttr "turbulenceField1.of[0]" "fluidShape1.ifc[5]";
connectAttr "fluidShape1.fd" "vortexField1.ind[3]";
connectAttr "fluidShape1.fd" "turbulenceField1.ind[0]";
